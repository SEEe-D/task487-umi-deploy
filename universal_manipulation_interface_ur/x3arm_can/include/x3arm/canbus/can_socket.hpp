...
public:
  ...
  // Callback signature: void(const can_frame& frame, bool is_tx)
  using TrafficCallback = std::function<void(const can_frame &, bool)>;
  void set_traffic_callback(TrafficCallback callback) {
    traffic_callback_ = callback;
  }
