#!/bin/bash
# ============================================================
# pi0.5 UMI6 单臂 train/test split 版微调 (~40GB VRAM/卡)
#
...
#
# Usage:
#   bash scripts/finetune_umi6_split.sh
# ============================================================
...
EXP_NAME="${1:-umi6_split}"

echo "===== pi0.5 UMI6 train split 微调 ====="
echo "Config: pi05_umi6_single_task_split"
echo "Exp: ${EXP_NAME}"
