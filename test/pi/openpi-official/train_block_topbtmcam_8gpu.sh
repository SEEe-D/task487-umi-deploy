...
CONFIG_NAME="pi05_block_topbtmcam_h20"
CKPT_DIR="/workspace/zt/checkpoints/${CONFIG_NAME}/${CONFIG_NAME}"
STATS_DIR="assets/${CONFIG_NAME}/local/block_topbtmcam"

# 1. 数据转换
echo ">>> 转换数据: blocktopbottomcam (上下拼图)"
python examples/umi/convert_zarr_to_lerobot.py \
    --zarr_path /workspace/umi/mydata/blocktopbottomcam.zarr.zip \
